			...
			<div class="box box-info">
                ...
                <div id="result" style="width: 100%;" class="table-responsive">
						...
						<tbody>
								...
								$no = 1;
								$arrayResult = $objTransaksi->LihatSemuaTransaksi(); //ubah jadi kategori
								foreach ($arrayResult as $dataTransaksi) {
									...
									echo '<td><a class="btn btn-warning btn-sm"  href="dashboard.php?p=ubahkategori&id_kategori=' . $dataTransaksi->id_transaksi . '">Ubah</a>
											  <a class="btn btn-danger btn-sm"  href="dashboard.php?p=hapuskategori&id_kategori=' . $dataTransaksi->id_transaksi . '" 
