...
if (isset($_POST['btnSubmit'])) {
  ...
  $objItemPesanan->TambahItemPesanan();

  echo "<script> alert('$objItemPesanan->message'); </script>";
  if ($objItemPesanan->hasil) {
    echo '<script> window.location="dashboard.php?p=lihatitempesanan"; </script>'; //ganti jadi lihat pesanan
  }
}
?>
            ...
            <div class="col-md-5"><!--COLUMN-->
              ...
              <div class="row"><!--ROW ID Kategori-->
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="id_item_pesanan" name="id_item_pesanan" readonly>
                  </div>
                </div>
              </div>
              ...
              <div class="row"><!--ROW Harga Modal-->
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="harga_modal" name="harga_modal" required>
                  </div>
                </div>
              </div>
